...
class IssledovanieFkuzType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('nomer', 'text', array(
                ...
                ->add('pokazatelsIssledovaniyFkuz', CollectionType::class, array(
                    'entry_type' => PokazatelsIssledovaniyaFkuzType::class,
                    'allow_add'    => true,
                    'by_reference' => false));
    }
