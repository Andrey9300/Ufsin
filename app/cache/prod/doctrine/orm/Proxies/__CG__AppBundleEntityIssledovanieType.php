 ...
 */
class IssledovanieType extends \AppBundle\Entity\IssledovanieType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\IssledovanieType' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\IssledovanieType' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\IssledovanieType' . "\0" . 'is_parent', '' . "\0" . 'AppBundle\\Entity\\IssledovanieType' . "\0" . 'children', '' . "\0" . 'AppBundle\\Entity\\IssledovanieType' . "\0" . 'parent');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IssledovanieType $proxy) {
