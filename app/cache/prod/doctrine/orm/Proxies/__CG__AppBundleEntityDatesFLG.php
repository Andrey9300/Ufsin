 ...
 */
class DatesFLG extends \AppBundle\Entity\DatesFLG implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\DatesFLG' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\DatesFLG' . "\0" . 'result', '' . "\0" . 'AppBundle\\Entity\\DatesFLG' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\DatesFLG' . "\0" . 'osugdenyi');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DatesFLG $proxy) {
