 ...
 */
class SoputPatol extends \AppBundle\Entity\SoputPatol implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SoputPatol' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\SoputPatol' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\SoputPatol' . "\0" . 'osugdenyi');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SoputPatol $proxy) {
