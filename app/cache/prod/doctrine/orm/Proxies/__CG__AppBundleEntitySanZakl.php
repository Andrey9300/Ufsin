 ...
 */
class SanZakl extends \AppBundle\Entity\SanZakl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SanZakl' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\SanZakl' . "\0" . 'nomer', '' . "\0" . 'AppBundle\\Entity\\SanZakl' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\SanZakl' . "\0" . 'vidDeytelnosti', '' . "\0" . 'AppBundle\\Entity\\SanZakl' . "\0" . 'fkuz');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SanZakl $proxy) {
    ...
    public function setVidDeytelnosti($vidDeytelnosti)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVidDeytelnosti', array($vidDeytelnosti));

        return parent::setVidDeytelnosti($vidDeytelnosti);
    }
    ...
    public function getVidDeytelnosti()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVidDeytelnosti', array());

        return parent::getVidDeytelnosti();
    }
