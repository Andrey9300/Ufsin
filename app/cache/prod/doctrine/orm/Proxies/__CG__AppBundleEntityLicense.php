 ...
 */
class License extends \AppBundle\Entity\License implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\License' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\License' . "\0" . 'nomer', '' . "\0" . 'AppBundle\\Entity\\License' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\License' . "\0" . 'vidDeytelnosti', '' . "\0" . 'AppBundle\\Entity\\License' . "\0" . 'fkuz');
        }
